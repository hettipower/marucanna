...
if (is_user_logged_in()):
    ...
    if ( array_intersect( $allowed_roles, $user->roles ) ) :
        ...
        $dr_name = $user->data->display_name;
?>
                            ...
                            <td style="width: 540px;text-align: right;vertical-align: middle;">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#makeInactiveModal<?php echo $patient_post_id; ?>" >Make Patient inactive</a></li>
                                    </ul>
                                </div>

                                <div class="modal fade" id="makeInactiveModal<?php echo $patient_post_id; ?>" tabindex="-1" aria-labelledby="makeInactiveModal<?php echo $patient_post_id; ?>Label" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="makeInactiveModal<?php echo $patient_post_id; ?>Label">Make Patient inactive</h1>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <?php echo do_shortcode('[gravityform id="21" title="false" ajax="true" field_values="patient_id='.$patient_id.'&dr_name='.$dr_name.'"]'); ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
