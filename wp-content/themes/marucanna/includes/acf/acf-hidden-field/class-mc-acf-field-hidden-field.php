...
/**
 * mc_acf_field_hidden_field class.
 */
class mc_acf_field_hidden_field extends \acf_field {
	/**
	...
	public function __construct() {
		 ...
		 */
		$this->label = __( 'Hidden field', 'mc-acf' );
		 ...
		 */
		$this->description = __( 'This is Hidden field for acf', 'mc-acf' );
		 ...
		 *
		 * ```js
		 * const errorMessage = acf._e("hidden_field", "error");
		 * ```
		 */
		$this->l10n = array(
			'error'	=> __( 'Error! Please enter a higher value', 'mc-acf' ),
		);

		$this->env = array(
			'url'     => site_url( str_replace( ABSPATH, '', __DIR__ ) ), // URL to the acf-hidden-field directory.
