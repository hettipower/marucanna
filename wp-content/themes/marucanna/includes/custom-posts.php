...
// Register Custom Post Type - Consultation
function mc_consultation_post_type() {

	$labels = array(
		'name'                  => _x( 'Consultation', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'Consultation', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Manage Consultation', 'text_domain' ),
		'name_admin_bar'        => __( 'Consultation', 'text_domain' ),
		'archives'              => __( 'Item Archives', 'text_domain' ),
		'attributes'            => __( 'Item Attributes', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent', 'text_domain' ),
		'all_items'             => __( 'Manage Consultation', 'text_domain' ),
		'add_new_item'          => __( 'Add New', 'text_domain' ),
		'add_new'               => __( 'Add New', 'text_domain' ),
		'new_item'              => __( 'New Item', 'text_domain' ),
		'edit_item'             => __( 'Edit', 'text_domain' ),
	...
	$args = array(
		'label'                 => __( 'Consultation', 'text_domain' ),
		'description'           => __( 'Consultation', 'text_domain' ),
		'labels'                => $labels,
		'supports'              => array( 'title'),
		'hierarchical'          => false,
		'public'                => true,
...
add_action( 'init', 'mc_consultation_post_type', 0 );