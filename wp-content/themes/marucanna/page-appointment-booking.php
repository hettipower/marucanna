...
<div class="modal fade" id="gpListModal" tabindex="-1" aria-labelledby="gpListModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="gpListModalLabel">Select GP Address</h1>
            </div>
            <div class="modal-body">
                <div id="gp_list_wrap"></div>
            </div>
        </div>
    </div>
</div>
